...
fish_g %>% 
  ggplot(aes(year, length_in_cm, color = district)) +
  scale_color_viridis(discrete = TRUE) +
  geom_point() +
  facet_wrap(vars(common_name)) + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1)) +
  labs(x = "Year", y = "Length (cm)", color = "District")
...
fish_g %>% 
  ggplot(aes(month, length_in_cm, color = district)) +
  scale_color_viridis(discrete = TRUE) +
  geom_point() +
  facet_wrap(vars(common_name)) + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1)) +
  labs(x = "Month", y = "Length (cm)", color = "District")
...
#Weight by year, district
recfin_g %>% 
  ggplot(aes(RECFIN_YEAR, sum_total_mortality_g, color = DISTRICT_NAME)) +
  scale_color_viridis(discrete = TRUE) +
  geom_point() +
...
#Weight by month, district
recfin_g %>% 
  ggplot(aes(RECFIN_MONTH, sum_total_mortality_g, color = DISTRICT_NAME)) +
  scale_color_viridis(discrete = TRUE) +
  geom_point() +
  facet_wrap(vars(SPECIES_NAME)) + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1)) +
